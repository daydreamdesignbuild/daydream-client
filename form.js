(function() {
  ...
  wrap.innerHTML = [
    ...
    '        <div class="dd-toggle-label">Contractor</div>',
    '        <div class="dd-toggle-sub">I am submitting on behalf of a client or project</div>',
    '      </div>',
    ...
    '      <div class="dd-input-inner">',
    '        <label class="dd-input-label">Company Name</label>',
    '        <input type="text" id="ddCompany" placeholder="e.g. Smith Contracting LLC" />',
    '      </div>',
    '    </div>',
    '  </div>',
