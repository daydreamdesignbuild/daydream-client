(function() {
  ...
  wrap.innerHTML = [
    ...
    '      <select id="ddIsContractor">',
    '        <option value="">Select an option</option>',
    '        <option value="no">No — I am the homeowner</option>',
    '        <option value="yes">Yes — I am a contractor</option>',
    '      </select>',
    '      <span class="dd-arrow">&#9662;</span>',
    '    </div>',
    '  </div>',
    '  <div class="dd-field dd-full" id="ddCompanyWrap" style="display:none">',
