(function() {
  ...
  wrap.innerHTML = [
    ...
    '    <div class="dd-contractor-row">',
    '      <label class="dd-contractor-check">',
    '        <input type="checkbox" id="ddIsContractor" />',
    '        <span class="dd-contractor-box"></span>',
    '        <span class="dd-contractor-text">I am a contractor submitting on behalf of a client or project</span>',
    '      </label>',
    '      <div id="ddCompanyWrap" style="display:none;margin-top:16px">',
    '        <label class="dd-input-label">Company Name</label>',
    '        <input type="text" id="ddCompany" class="dd-company-input" placeholder="e.g. Smith Contracting LLC" />',
    '      </div>',
    '    </div>',
    '  </div>',
