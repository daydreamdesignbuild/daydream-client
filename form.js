(function() {
  ...
  wrap.innerHTML = [
    ...
    '    <label class="dd-check-row">',
    '      <input type="checkbox" id="ddIsContractor" class="dd-checkbox" />',
    '      <div class="dd-check-info">',
    '        <div class="dd-check-label">I am a contractor</div>',
    '        <div class="dd-check-sub">Submitting on behalf of a client or project</div>',
    '      </div>',
    '    </label>',
