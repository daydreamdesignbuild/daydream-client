(function() {
  ...
  wrap.innerHTML = [
    ...
    '  <div class="dd-section">Service &amp; Identity</div>',
    '  <div class="dd-row" style="grid-template-columns:1fr 1fr 1fr">',
    '    <div class="dd-field">',
    '      <label class="dd-label">Service Interest *</label>',
    ...
    '    </div>',
    '    <div class="dd-field">',
    '      <label class="dd-label">Are You a Contractor?</label>',
    '      <div class="dd-select-wrap"><select id="ddIsContractor"><option value="">Select an option</option><option value="no">No — Homeowner</option><option value="yes">Yes — Contractor</option></select><span class="dd-arrow">&#9662;</span></div>',
    '    </div>',
    '    <div class="dd-field">',
