(function() {
  ...
  style.textContent = [
    ...
    '  color: var(--text); width: 100%; max-width: 660px; margin: 0 auto; padding: 48px 0;',
    '}',
  ...
  wrap.innerHTML = [
    ...
    '  <div class="dd-field dd-full" style="padding:8px 0 4px">',
    '    <div style="border-top:1px solid rgba(255,255,255,0.1);padding-top:20px;margin-top:4px">',
    '      <label style="display:flex;align-items:center;gap:12px;cursor:pointer">',
    '        <input type="checkbox" id="ddIsContractor" style="width:18px;height:18px;min-width:18px;accent-color:#eeb24a;cursor:pointer" />',
    '        <span style="font-size:13px;color:#f0ebe0;line-height:1.5">I am a contractor submitting on behalf of a client or project</span>',
    '      </label>',
    '      <div id="ddCompanyWrap" style="display:none;margin-top:16px">',
    '        <label style="display:block;font-size:10px;letter-spacing:0.25em;text-transform:uppercase;color:#8a8680;margin-bottom:8px">Company Name</label>',
    '        <input type="text" id="ddCompany" placeholder="e.g. Smith Contracting LLC" style="width:100%;background:transparent;border:none;border-bottom:1px solid rgba(255,255,255,0.2);color:#f0ebe0;font-size:14px;padding:8px 0;outline:none" />',
    '      </div>',
    '    </div>',
    '  </div>',
