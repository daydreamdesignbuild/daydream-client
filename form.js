(function() {
  ...
  style.textContent = `
    #dd-form-wrap * { box-sizing: border-box; }
    #dd-form-wrap {
      --bg: #0d0d0b; --surface: #131310; --surface-2: #181815;
      --border: #252520; --text: #f0ebe0; --muted: #8a8680;
      --gold: #eeb24a; --gold-dim: rgba(238,178,74,0.07);
      --gold-glow: rgba(238,178,74,0.15); --error: #c07a6a;
      font-family: 'Jost', sans-serif; font-weight: 300;
      color: var(--text); width: 100%; max-width: 660px;
...
#dd-form-wrap .dd-field select:-webkit-autofill:focus {
  ...
  background-color: #131310 !important;
    ...
    #dd-form-wrap button[type="submit"]:hover { background: var(--gold); color: #0d0d0b; box-shadow: 0 0 30px rgba(238,178,74,0.15); }
    ...
    #dd-form-wrap .dd-success { display: none; text-align: center; padding: 60px 20px; animation: ddFadeUp 0.7s ease both; }
  ...
  wrap.innerHTML = `
    ...
    <form id="ddForm">
      ...
      <div class="dd-row">
        <div class="dd-field"><label for="ddFirstName">First Name</label><input type="text" id="ddFirstName" placeholder="Jane" required /></div>
        <div class="dd-field"><label for="ddLastName">Last Name</label><input type="text" id="ddLastName" placeholder="Smith" required /></div>
      </div>
      <div class="dd-row">
        <div class="dd-field"><label for="ddEmail">Email Address</label><input type="email" id="ddEmail" placeholder="youremail@email.com" required /></div>
        <div class="dd-field"><label for="ddPhone">Phone Number</label><input type="tel" id="ddPhone" placeholder="+1 (404) 000-0000" /></div>
      </div>
      ...
      <div class="dd-field dd-full"><label for="ddStreet">Street Address</label><input type="text" id="ddStreet" placeholder="123 Peachtree Street NE" /></div>
      <div class="dd-row-3">
        <div class="dd-field"><label for="ddCity">City</label><input type="text" id="ddCity" placeholder="Atlanta" /></div>
        <div class="dd-field"><label for="ddState">State</label><input type="text" id="ddState" placeholder="GA" /></div>
        <div class="dd-field"><label for="ddZip">Zip Code</label><input type="text" id="ddZip" placeholder="30067" /></div>
      </div>

      <div class="dd-section">Project Details</div>
      <div class="dd-field dd-full">
        <label for="ddReferral">How Did You Hear About Us?</label>
      ...
      <div class="dd-field dd-full">
        <label for="ddServices">What Design Services Are You Interested In?</label>
      ...
      <div class="dd-field dd-full"><label for="ddInvestment">What Level of Investment Are You Preparing for This Project?</label><input type="text" id="ddInvestment" placeholder="e.g. $75,000" /></div>
      <div class="dd-field dd-full"><label for="ddNotes">Anything Else We Need to Know?</label><textarea id="ddNotes" placeholder="Tell us about your vision, timeline, or any other details..."></textarea></div>

      <div class="dd-submit-wrap">
        <div class="dd-error" id="ddError">Something went wrong. Please try again.</div>
        <button type="submit" id="ddSubmit">
  ...
  var SUPABASE_ANON_KEY = 'sb_publishable_0Pcs1MVkQt4ILtrN_luJ6Q_9JeR2KNU';

  var form = document.getElementById('ddForm');
  var submitBtn = document.getElementById('ddSubmit');
  var errorMsg = document.getElementById('ddError');
  var successScreen = document.getElementById('ddSuccess');
  ...
  form.addEventListener('submit', async function(e) {
    ...
    var data = {
      full_name: document.getElementById('ddFirstName').value.trim() + ' ' + document.getElementById('ddLastName').value.trim(),
