(function () {
  ...
  style.textContent = [
    ...
    '#dd-portal .dd-login-logo { font-family: "Cormorant Garamond", serif; font-size: 34px; font-weight: 400; letter-spacing: 0.22em; color: var(--gold-light); text-transform: uppercase; margin-bottom: 11px; }',
    '#dd-portal .dd-login-sub { font-size: 9px; letter-spacing: 0.36em; text-transform: uppercase; color: rgba(250,248,245,0.6); }',
    ...
    '  #dd-portal .dd-tabs { display: flex !important; overflow-x: auto; overflow-y: visible; justify-content: flex-start; padding: 0; scrollbar-width: none; -webkit-overflow-scrolling: touch; background: var(--surface); border-bottom: 1px solid var(--border); width: 100%; flex-shrink: 0; position: relative; }',
  ...
  wrap.innerHTML = [
    ...
    '    <div class="dd-login-header"><div class="dd-login-logo">Daydream</div><div class="dd-login-sub">Design + Build &nbsp;&middot;&nbsp; Stone Atelier</div></div>',
